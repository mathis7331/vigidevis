        ...
        try {
          ...
          if (!checkData.success || !checkData.valid) {
            toast.error('Photo non reconnue', {
              id: 'upload',
              description: "Assure-toi que la photo montre bien un vêtement."
            });
          ...
          toast.error('Erreur réseau', { id: 'upload' });
          setIsAnalyzing(false);
        }
      };
    ...
    <div className="relative min-h-screen bg-secondary overflow-hidden">
        ...
        >
          ...
          <div className="relative z-20">
            ...
            >
              ...
              >
                L'IA analyse ton vêtement, génère l'annonce parfaite et te dit combien ça vaut vraiment.
                <span className="text-primary font-semibold"> Fini la galère.</span>
              </motion.p>
                ...
                <div className="aspect-[9/19] bg-gradient-to-br from-secondary to-secondary/80 rounded-2xl p-4 flex flex-col">
                  ...
                  <div className="flex-1 flex items-center justify-center">
                    ...
                    >
                      ...
                      <p className="text-primary font-black text-2xl">45,00 €</p>
                    </motion.div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-text/70 text-xl max-w-2xl mx-auto">
              Technologie de pointe pour des résultats exceptionnels
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <BentoCard className="md:col-span-2 lg:row-span-2 p-8">
              <div className="h-full flex flex-col">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-black text-text">Analyse IA Avancée</h3>
                </div>
                ...
                <p className="text-text/70 text-sm mt-6">
                  Notre IA scanne chaque détail pour identifier marque, état et valeur réelle.
                </p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="p-6">
              <div className="text-center">
                ...
                <p className="text-text/70 text-sm">Par analyse complète</p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="p-6">
              <div className="text-center">
                ...
                <p className="text-text/70 text-sm">Résultat instantané</p>
              </div>
            </BentoCard>
            ...
            <BentoCard className="md:col-span-2 p-6">
              <div className="flex items-center justify-between h-full">
                <div>
                  ...
                  <p className="text-text/70 text-sm">Vos données sont chiffrées et jamais partagées</p>
                </div>
            ...
            {[...Array(8)].map((_, i) => (
              <div key={i} className="flex gap-8">
                <div className="flex items-center gap-3 px-6 py-3 bg-surface/50 backdrop-blur-sm rounded-full border border-white/10">
                  ...
                  <span className="text-text font-medium">💸 Sarah a gagné +45€</span>
                </div>
                <div className="flex items-center gap-3 px-6 py-3 bg-surface/50 backdrop-blur-sm rounded-full border border-white/10">
                  <div className="w-8 h-8 rounded-full bg-accent/20 flex items-center justify-center">
                    <ShoppingBag className="w-4 h-4 text-accent" />
                  </div>
                  <span className="text-text font-medium">📦 Thomas a expédié son colis</span>
                </div>
                <div className="flex items-center gap-3 px-6 py-3 bg-surface/50 backdrop-blur-sm rounded-full border border-white/10">
                  <div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center">
                    <Zap className="w-4 h-4 text-primary" />
                  </div>
                  <span className="text-text font-medium">⚡ Léa a vendu en 10 minutes</span>
                </div>
                <div className="flex items-center gap-3 px-6 py-3 bg-surface/50 backdrop-blur-sm rounded-full border border-white/10">
                  <div className="w-8 h-8 rounded-full bg-accent/20 flex items-center justify-center">
      ...
      <section id="upload" className="relative py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-black text-text mb-6">
              Prêt à <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">booster</span> ton dressing ?
            </h2>
            <p className="text-text/70 text-xl max-w-2xl mx-auto">
              Glisse ta photo de vêtement et découvre sa valeur réelle en quelques secondes
            </p>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-text/60 text-xl max-w-2xl mx-auto mb-12">
              Rejoins les milliers d'utilisateurs qui ont boosté leurs ventes avec VINTED-TURBO
            </p>
          </motion.div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <p className="text-sm text-gray-500">
                  © 2024 VINTED-TURBO. Fait avec amour pour les etudiants.
                </p>
              </div>
            </div>
          </div>
